...
def main():
 ...
 for e in range(1,a.epochs+1):
  ...
  if e==1 or e%25==0 or e==a.epochs:
   ...
   meta={'format_version':3,'model_config':model.config(),'tokenizer':'data/tokenizer.json','tokenizer_sha256':sha256(tok_path),'epoch':e,'train_loss':tl,'val_loss':vl,'version':'2.5.0'}
